...
class WorkOrderController extends Controller
{
    ...
    public function complete(Request $request, WorkOrder $workOrder)
    {
        ...
        DB::transaction(function () use ($workOrder, $validated) {
            ...
            // Maintenance Scheduling — rolling rhythm: if this work
            // order was generated by a recurring schedule, advance
            // that schedule's next due date from THIS completion
            // moment, not from the original due date. A late
            // occurrence doesn't compound into future lateness.
